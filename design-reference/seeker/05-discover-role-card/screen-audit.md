# Screen audit: Discover role card

## Source reviewed
- Composite: `_incoming/seeker/5.png`
- Phone panel: 2
...
- Await flat export, font, icon, artwork, and crop manifest before implementation approval.
